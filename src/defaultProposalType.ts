...
export const defaultProposalTypeValueDecoder: Decoder<DefaultProposalTypeValue> = mapDecoderOption(
  uint16Decoder,
  (v) => (defaultProposalTypeValues.has(v) ? (v as DefaultProposalTypeValue) : undefined),
)
